...
INSERT INTO `node_mysql_crud_db`.`programs` (`codigo`, `name_program`, `description`, `is_deleted`, `created_at`) VALUES ('85469', 'Tecnico en Sistemas', 'Formacion en mantenimiento, redes y Herr. Ofimatica', '0', '2019-11-19 03:30:30');
INSERT INTO `node_mysql_crud_db`.`programs` (`codigo`, `name_program`, `description`, `is_deleted`, `created_at`) VALUES ('20256', 'Programacion de software', 'programacion de aplicativos web, movil y de escritorio', '0', '2019-11-19 03:30:30');
